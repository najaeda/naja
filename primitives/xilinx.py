...
def constructSequentialPrimitive(design, clk):
    ...
    snl.SNLDesign.addClockToOutputsArcs(clk, output_terms)
...
def constructRAM32M(lib):
    ...
    doa = snl.SNLBusTerm.create(ram32m, snl.SNLTerm.Direction.Output, 1, 0, "DOA")
    dob = snl.SNLBusTerm.create(ram32m, snl.SNLTerm.Direction.Output, 1, 0, "DOB")
    doc = snl.SNLBusTerm.create(ram32m, snl.SNLTerm.Direction.Output, 1, 0, "DOC")
    dod = snl.SNLBusTerm.create(ram32m, snl.SNLTerm.Direction.Output, 1, 0, "DOD")
    addra = snl.SNLBusTerm.create(ram32m, snl.SNLTerm.Direction.Input, 4, 0, "ADDRA")
    addrb = snl.SNLBusTerm.create(ram32m, snl.SNLTerm.Direction.Input, 4, 0, "ADDRB")
    addrc = snl.SNLBusTerm.create(ram32m, snl.SNLTerm.Direction.Input, 4, 0, "ADDRC")
    addrd = snl.SNLBusTerm.create(ram32m, snl.SNLTerm.Direction.Input, 4, 0, "ADDRD")
    snl.SNLDesign.addCombinatorialArcs(doa, list(addra.getBits()))
    snl.SNLDesign.addCombinatorialArcs(dob, list(addrb.getBits()))
    snl.SNLDesign.addCombinatorialArcs(doc, list(addrc.getBits()))
    snl.SNLDesign.addCombinatorialArcs(dod, list(addrd.getBits()))
    dia = snl.SNLBusTerm.create(ram32m, snl.SNLTerm.Direction.Input, 1, 0, "DIA")
    dib = snl.SNLBusTerm.create(ram32m, snl.SNLTerm.Direction.Input, 1, 0, "DIB")
    dic = snl.SNLBusTerm.create(ram32m, snl.SNLTerm.Direction.Input, 1, 0, "DIC")
    did = snl.SNLBusTerm.create(ram32m, snl.SNLTerm.Direction.Input, 1, 0, "DID")
    wclk = snl.SNLScalarTerm.create(ram32m, snl.SNLTerm.Direction.Input, "WCLK")
    we = snl.SNLScalarTerm.create(ram32m, snl.SNLTerm.Direction.Input, "WE")
    snl.SNLDesign.addInputsToClockArcs([dia, dib, dic, did, we], wclk)
...
def constructRAM64M(lib):
    ...
    doa = snl.SNLScalarTerm.create(ram64m, snl.SNLTerm.Direction.Output, "DOA")
    dob = snl.SNLScalarTerm.create(ram64m, snl.SNLTerm.Direction.Output, "DOB")
    doc = snl.SNLScalarTerm.create(ram64m, snl.SNLTerm.Direction.Output, "DOC")
    dod = snl.SNLScalarTerm.create(ram64m, snl.SNLTerm.Direction.Output, "DOD")
    addra = snl.SNLBusTerm.create(ram64m, snl.SNLTerm.Direction.Input, 5, 0, "ADDRA")
    addrb = snl.SNLBusTerm.create(ram64m, snl.SNLTerm.Direction.Input, 5, 0, "ADDRB")
    addrc = snl.SNLBusTerm.create(ram64m, snl.SNLTerm.Direction.Input, 5, 0, "ADDRC")
    addrd = snl.SNLBusTerm.create(ram64m, snl.SNLTerm.Direction.Input, 5, 0, "ADDRD")
    snl.SNLDesign.addCombinatorialArcs(doa, list(addra.getBits()))
    snl.SNLDesign.addCombinatorialArcs(dob, list(addrb.getBits()))
    snl.SNLDesign.addCombinatorialArcs(doc, list(addrc.getBits()))
    snl.SNLDesign.addCombinatorialArcs(dod, list(addrd.getBits()))
    dia = snl.SNLScalarTerm.create(ram64m, snl.SNLTerm.Direction.Input, "DIA")
    dib = snl.SNLScalarTerm.create(ram64m, snl.SNLTerm.Direction.Input, "DIB")
    dic = snl.SNLScalarTerm.create(ram64m, snl.SNLTerm.Direction.Input, "DIC")
    did = snl.SNLScalarTerm.create(ram64m, snl.SNLTerm.Direction.Input, "DID")
    wclk = snl.SNLScalarTerm.create(ram64m, snl.SNLTerm.Direction.Input, "WCLK")
    we = snl.SNLScalarTerm.create(ram64m, snl.SNLTerm.Direction.Input, "WE")
    snl.SNLDesign.addInputsToClockArcs([dia, dib, dic, did, we], wclk)
    ...
    snl.SNLParameter.create_binary(ram64m, "IS_WCLK_INVERTED", 1, 0)
...
def constructRAMB18E1(lib):
    ...
    addra = snl.SNLBusTerm.create(ramb18e1, snl.SNLTerm.Direction.Input, 13, 0, "ADDRARDADDR")
    a_inputs.extend(list(addra.getBits()))
    addrb = snl.SNLBusTerm.create(ramb18e1, snl.SNLTerm.Direction.Input, 13, 0, "ADDRBWRADDR")
    b_inputs.extend(list(addrb.getBits()))
    clka = snl.SNLScalarTerm.create(ramb18e1, snl.SNLTerm.Direction.Input, "CLKARDCLK")
    clkb = snl.SNLScalarTerm.create(ramb18e1, snl.SNLTerm.Direction.Input, "CLKBWRCLK")
    diadi = snl.SNLBusTerm.create(ramb18e1, snl.SNLTerm.Direction.Input, 15, 0, "DIADI")
    a_inputs.extend(list(diadi.getBits()))
    dibdi = snl.SNLBusTerm.create(ramb18e1, snl.SNLTerm.Direction.Input, 15, 0, "DIBDI")
    b_inputs.extend(list(dibdi.getBits()))
    dipadip = snl.SNLBusTerm.create(ramb18e1, snl.SNLTerm.Direction.Input, 1, 0, "DIPADIP")
    a_inputs.extend(list(dipadip.getBits()))
    dipbdip = snl.SNLBusTerm.create(ramb18e1, snl.SNLTerm.Direction.Input, 1, 0, "DIPBDIP")
    b_inputs.extend(list(dipbdip.getBits()))
    doado = snl.SNLBusTerm.create(ramb18e1, snl.SNLTerm.Direction.Output, 15, 0, "DOADO")
    a_outputs.extend(list(doado.getBits()))
    dobdo = snl.SNLBusTerm.create(ramb18e1, snl.SNLTerm.Direction.Output, 15, 0, "DOBDO")
    b_outputs.extend(list(dobdo.getBits()))
    dopadop = snl.SNLBusTerm.create(ramb18e1, snl.SNLTerm.Direction.Output, 1, 0, "DOPADOP")
    a_outputs.extend(list(dopadop.getBits()))
    dopbdop = snl.SNLBusTerm.create(ramb18e1, snl.SNLTerm.Direction.Output, 1, 0, "DOPBDOP")
    b_outputs.extend(list(dopbdop.getBits()))
    enarden = snl.SNLScalarTerm.create(ramb18e1, snl.SNLTerm.Direction.Input, "ENARDEN")
    a_inputs.append(enarden)
    enbwren = snl.SNLScalarTerm.create(ramb18e1, snl.SNLTerm.Direction.Input, "ENBWREN")
    b_inputs.append(enbwren)
    regcear = snl.SNLScalarTerm.create(ramb18e1, snl.SNLTerm.Direction.Input, "REGCEAREGCE")
    a_inputs.append(regcear)
    regceb = snl.SNLScalarTerm.create(ramb18e1, snl.SNLTerm.Direction.Input, "REGCEB")
    b_inputs.append(regceb)
    rstrama = snl.SNLScalarTerm.create(ramb18e1, snl.SNLTerm.Direction.Input, "RSTRAMARSTRAM")
    a_inputs.append(rstrama)
    rstramb = snl.SNLScalarTerm.create(ramb18e1, snl.SNLTerm.Direction.Input, "RSTRAMB")
    b_inputs.append(rstramb)
    rstregar = snl.SNLScalarTerm.create(ramb18e1, snl.SNLTerm.Direction.Input, "RSTREGARSTREG")
    a_inputs.append(rstregar)
    rstregb = snl.SNLScalarTerm.create(ramb18e1, snl.SNLTerm.Direction.Input, "RSTREGB")
    b_inputs.append(rstregb)
    wea = snl.SNLBusTerm.create(ramb18e1, snl.SNLTerm.Direction.Input, 1, 0, "WEA")
    a_inputs.extend(list(wea.getBits()))
    webwe = snl.SNLBusTerm.create(ramb18e1, snl.SNLTerm.Direction.Input, 3, 0, "WEBWE")
    ...
    snl.SNLDesign.addInputsToClockArcs(a_inputs, clka)
    snl.SNLDesign.addInputsToClockArcs(b_inputs, clkb)
    snl.SNLDesign.addClockToOutputsArcs(clka, a_outputs)
    snl.SNLDesign.addClockToOutputsArcs(clkb, b_outputs)
...
def constructRAMB36E1(lib):
    ...
    addra = snl.SNLBusTerm.create(ramb36e1, snl.SNLTerm.Direction.Input, 15, 0, "ADDRARDADDR")
    a_inputs.extend(list(addra.getBits()))
    addrb = snl.SNLBusTerm.create(ramb36e1, snl.SNLTerm.Direction.Input, 15, 0, "ADDRBWRADDR")
    b_inputs.extend(list(addrb.getBits()))
    ...
    clka = snl.SNLScalarTerm.create(ramb36e1, snl.SNLTerm.Direction.Input, "CLKARDCLK")
    clkb = snl.SNLScalarTerm.create(ramb36e1, snl.SNLTerm.Direction.Input, "CLKBWRCLK")
    ...
    b_inputs.append(enbwren)
    injectdbiterr = snl.SNLScalarTerm.create(
        ramb36e1, snl.SNLTerm.Direction.Input, "INJECTDBITERR"
    )
    injectsbiterr = snl.SNLScalarTerm.create(
        ramb36e1, snl.SNLTerm.Direction.Input, "INJECTSBITERR"
    )
    ...
    b_inputs.append(regceb)
    rstramarstram = snl.SNLScalarTerm.create(
        ramb36e1, snl.SNLTerm.Direction.Input, "RSTRAMARSTRAM"
    )
    a_inputs.append(rstramarstram)
    rstramb = snl.SNLScalarTerm.create(ramb36e1, snl.SNLTerm.Direction.Input, "RSTRAMB")
    b_inputs.append(rstramb)
    rstregarstreg = snl.SNLScalarTerm.create(
        ramb36e1, snl.SNLTerm.Direction.Input, "RSTREGARSTREG"
    )
    ...
    wea = snl.SNLBusTerm.create(ramb36e1, snl.SNLTerm.Direction.Input, 3, 0, "WEA")
    a_inputs.extend(list(wea.getBits()))
    webwe = snl.SNLBusTerm.create(ramb36e1, snl.SNLTerm.Direction.Input, 7, 0, "WEBWE")
    b_inputs.extend(list(webwe.getBits()))
    snl.SNLDesign.addInputsToClockArcs(a_inputs, clka)
    snl.SNLDesign.addInputsToClockArcs(b_inputs, clkb)
    snl.SNLDesign.addClockToOutputsArcs(clka, a_outputs)
