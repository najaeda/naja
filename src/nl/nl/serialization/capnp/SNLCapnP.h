...
class SNLCapnP {
  public:
    ...
    static NLDB* load(const std::filesystem::path& dumpPath, bool primitivesAreLoded = false);  
    ...
    static NLDB* loadInterface(int fileDescriptor, bool primitivesAreLoded = false);
    static NLDB* loadInterface(const std::filesystem::path& interfacePath, bool primitivesAreLoded = false);
