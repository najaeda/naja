...
find_library(NAJA_SNL_PRIMITIVES_LIBRARY NAMES naja_snl_primitives
   HINTS
   $ENV{NAJA_INSTALL}/lib
)
...
FIND_PACKAGE_HANDLE_STANDARD_ARGS(Naja
  ...
  NAJA_SNL_LIBRARY NAJA_SNL_VERILOG_LIBRARY NAJA_SNL_PRIMITIVES_LIBRARY)
...
if(Naja_FOUND AND NOT TARGET Naja::SNL)
  ...
  add_library(Naja::SNLPrimitives UNKNOWN IMPORTED)
  set_target_properties(Naja::SNLPrimitives PROPERTIES
    IMPORTED_LOCATION ${NAJA_SNL_PRIMITIVES_LIBRARY}
    INTERFACE_INCLUDE_DIRECTORIES ${NAJA_INCLUDE_DIRS}
  ...
  set_target_properties(Naja::SNLVerilog PROPERTIES
    ...
    INTERFACE_INCLUDE_DIRECTORIES ${NAJA_INCLUDE_DIRS}
    IMPORTED_LINK_INTERFACE_LIBRARIES Naja::SNLPrimitives)
endif()
