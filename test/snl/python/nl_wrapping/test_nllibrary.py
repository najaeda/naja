...
class NLLibraryTest(unittest.TestCase):
  ...
  def test(self):
    ...
    #Create library
    lib1 = snl.NLLibrary.create(db, "LIB1")
    ...
    #Create sublib
    lib2 = snl.NLLibrary.create(lib1, "LIB2")
    ...
    anonlib = snl.NLLibrary.create(lib1)
  ...
  def testErrors(self):
    ...
    with self.assertRaises(RuntimeError) as context: lib1 = snl.NLLibrary.create(db, "LIB1", "ERROR")
    with self.assertRaises(RuntimeError) as context: lib1 = snl.NLLibrary.create(u, "LIB1")

    lib = snl.NLLibrary.create(db, "LIB")
    with self.assertRaises(RuntimeError) as context: lib1 = snl.NLLibrary.create(db, "LIB")
