...
class NajaNetlistTest0(unittest.TestCase):
    ...
    def test_const_nets(self):
        ...
        net.set_type(netlist.Net.Type.ASSIGNX)
        self.assertTrue(net.is_const())
        self.assertTrue(net.is_constx())
        self.assertFalse(net.is_constz())
        net.set_type(netlist.Net.Type.ASSIGNZ)
        self.assertTrue(net.is_const())
        self.assertFalse(net.is_constx())
        self.assertTrue(net.is_constz())
        net.set_type(netlist.Net.Type.ASSIGN1)
        ...
        equi = top_i0.get_equipotential()
        self.assertIsNotNone(equi)
        self.assertTrue(equi.is_constx())
        self.assertFalse(equi.is_constz())
        self.assertTrue(equi.is_const())
        net.set_type(netlist.Net.Type.ASSIGNZ)
        equi = top_i0.get_equipotential()
        self.assertIsNotNone(equi)
        self.assertFalse(equi.is_constx())
        self.assertTrue(equi.is_constz())
        self.assertTrue(equi.is_const())
