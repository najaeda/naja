...
class NajaNetlistTest1(unittest.TestCase):
    ...
    def test_browse(self):
        ...
        self.assertEqual([ins0.get_term('I0').get_bit(0)], list(i0Net.get_bit(0).get_inst_terms()))
        self.assertEqual([ins0.get_term('I1').get_bit(0)], list(i1Net.get_bit(0).get_inst_terms()))
