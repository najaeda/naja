...
class NajaNetlistTest1(unittest.TestCase):
    def setUp(self):
        ...
        i0.connect_upper_net(i0Net)
        i1 = top.create_input_bus_term('I1', 1, 0)
        i1Net = top.create_bus_net('I1', 1, 0)
        i1.connect_upper_net(i1Net)
        o = top.create_output_term('O')
        oNet = top.create_net('O')
        o.connect_upper_net(oNet)
        ins0 = top.create_child_instance('Module0', 'Ins0')
        ins0.get_term('I0').connect_upper_net(i0Net.get_bit(0))
        ins0.get_term('I1').connect_upper_net(i1Net.get_bit(0))
        ins1 = top.create_child_instance('Module0', 'Ins1')
        ins1.get_term('I0').connect_upper_net(i0Net.get_bit(1))
        ins1.get_term('I1').connect_upper_net(i1Net.get_bit(1))
        ins2 = top.create_child_instance('OR2', 'Ins2')
        wire = top.create_bus_net('net', 1, 0)
        ins2.get_term('I0').connect_upper_net(wire.get_bit(1))
        ins2.get_term('I1').connect_upper_net(wire.get_bit(0))
        ins2.get_term('O').connect_upper_net(oNet)
    ...
    def test_browse(self):
        ...
        self.assertEqual(2+2+1, sum(1 for _ in top.get_bit_terms()))
        self.assertEqual(2+2+1, top.count_bit_terms())
        self.assertEqual(4, sum(1 for _ in top.get_nets()))
        self.assertEqual(4, top.count_nets())
        self.assertEqual(2+2+1+2, sum(1 for _ in top.get_bit_nets()))
        self.assertEqual(2+2+1+2, top.count_bit_nets())
        self.assertEqual(2, sum(1 for _ in top.get_input_terms()))
        self.assertEqual(2, top.count_input_terms())
        self.assertEqual(2+2, sum(1 for _ in top.get_input_bit_terms()))
        self.assertEqual(2+2, top.count_input_bit_terms())
        self.assertEqual(1, sum(1 for _ in top.get_output_terms()))
        self.assertEqual(1, top.count_output_terms())
        self.assertEqual(1, sum(1 for _ in top.get_output_bit_terms()))
        self.assertEqual(1, top.count_output_bit_terms())
        ...
        self.assertEqual(1, i0.get_msb())
        self.assertEqual(0, i0.get_lsb())
        i0_bit0 = i0.get_bit(0)
        self.assertTrue(i0_bit0.is_bus_bit())
        self.assertIsNotNone(i0_bit0)
        self.assertEqual(0, i0_bit0.get_bit_number())
        i0_bit1 = i0.get_bit(1)
        self.assertIsNotNone(i0_bit1)
        self.assertTrue(i0_bit1.is_bus_bit())
        self.assertEqual(1, i0_bit1.get_bit_number())
        ...
        self.assertIsNone(i0.get_upper_net())
        ...
        self.assertEqual([i0.get_bit(0)], list(i0Net.get_bit(0).get_design_terms()))
        self.assertEqual([i0.get_bit(1)], list(i0Net.get_bit(1).get_design_terms()))
        self.assertIsNone(i1.get_upper_net())
        ...
        self.assertEqual([i0.get_bit(0), ins0.get_term('I0')], list(i0Net.get_bit(0).get_terms()))
        self.assertEqual([i1.get_bit(0), ins0.get_term('I1')], list(i1Net.get_bit(0).get_terms()))
        self.assertEqual([ins0.get_term('I1')], list(i1Net.get_bit(0).get_inst_terms()))
        self.assertEqual([i0.get_bit(1), ins1.get_term('I0')], list(i0Net.get_bit(1).get_terms()))
        self.assertEqual([i1.get_bit(1), ins1.get_term('I1')], list(i1Net.get_bit(1).get_terms()))
        self.assertIsNone(ins0.get_term('I0').get_bit(0))
        self.assertIsNone(ins0.get_term('I0').get_bit(4))
        self.assertEqual(ins0.get_term('I0').get_upper_net(), i0Net.get_bit(0))
        self.assertEqual(ins0.get_term('I1').get_upper_net(), i1Net.get_bit(0))
        ...
        self.assertIsNone(o.get_upper_net())
